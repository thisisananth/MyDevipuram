...
public class RegisterActivity extends Activity implements ValidationListener {
	...
	private class RegisterTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... voids) {
			...
			// HttpPost post = new
			// HttpPost("http://ec2-54-200-201-61.us-west-2.compute.amazonaws.com:8080/DPServices/services/users/create");

			HttpPost post = new HttpPost(Constants.WS_URL + "/users/create");
